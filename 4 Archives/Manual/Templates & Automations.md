The **main feature** of this template is the automations that help you quickly create top-level, sub-level and the bottom level notes in each project, area or resource.
